...
final class Bech32Tests: XCTestCase {
    ...
    func testBech32_encodePubKey() throws {
        ...
        let result = try Bech32Coder().encode(hrp: Bech32Coder.Prefix.publicKey, publicKeyHex)
    ...
    func testBech32_encodePrivateKey() throws {
        ...
        let result = try Bech32Coder().encode(hrp: Bech32Coder.Prefix.privateKey, privateKeyHex)
        XCTAssertEqual(result, bech32String)
    }
